...
#ifndef TB_ELEMENTS_POPUP_WINDOW_H_
#define TB_ELEMENTS_POPUP_WINDOW_H_
...
class PopupAlignment {
 public:
  static const int kUnspecified = tb::util::kInvalidDimension;
...
#endif  // TB_ELEMENTS_POPUP_WINDOW_H_
