...
void TBDebugOut(const char* str) { LOGI(str); }

#endif  // TB_RUNTIME_DEBUG_INFO

AAssetManager* g_pManager = NULL;

void SetAssetManager(AAssetManager* pManager) { g_pManager = pManager; }
...
int TBSystem::GetPanThreshold() { return 5 * GetDPI() / 120; }

int TBSystem::GetPixelsPerLine() { return 40 * GetDPI() / 120; }
...
int TBSystem::GetDPI() {
  ...
  if (density == 0 || density == ACONFIGURATION_DENSITY_NONE) return 120;
  return density;
}
