...
TBWidget::ScrollInfo TextBox::GetScrollInfo() {
  ScrollInfo info;
...
bool TextBox::OnEvent(const TBWidgetEvent& ev) {
...
void TextBox::Invalidate(const Rect& rect) { TBWidget::Invalidate(); }
