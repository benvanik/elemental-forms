...
class TBSkinElement {
 public:
  ...
  int16 img_ofs_x;      ///< X offset for type image. Relative to image position
                        ///(img_position_x).
  int16 img_ofs_y;      ///< Y offset for type image. Relative to image position
                        ///(img_position_y).
  int8 img_position_x;  ///< Horizontal position for type image. 0-100 (left to
                        ///< right in available space). Default 50.
  int8 img_position_y;  ///< Vertical position for type image. 0-100 (top to
  /// bottom
