...
#ifndef TB_TEXT_TEXT_FRAGMENT_H_
#define TB_TEXT_TEXT_FRAGMENT_H_
...
class TextBlock : public tb::util::IntrusiveListEntry<TextBlock> {
 public:
  ...
  void BuildSelectionRegion(int32_t translate_x, int32_t translate_y,
                            TextProps* props, tb::util::RectRegion* bg_region,
                            tb::util::RectRegion* fg_region);
...
class TextFragment : public tb::util::IntrusiveListEntry<TextFragment> {
 ...
 public:
  ...
  // automatically.
  int32_t GetStringWidth(tb::text::FontFace* font, const char* str, size_t len);
...
#endif  // TB_TEXT_TEXT_FRAGMENT_H_
