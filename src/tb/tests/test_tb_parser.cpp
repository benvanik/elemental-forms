...
TB_TEST_GROUP(tb_parser) {
  ...
  TB_TEST(strings) {
    ...
    TB_VERIFY_STR(node.GetValueString("strings>string4", ""),
                  "\"\'A string\'\"");
  ...
  TB_TEST(strings_compact) {
    ...
    TB_VERIFY_STR(node.GetValueString("strings_compact>string2", ""),
                  "A string");
    TB_VERIFY_STR(node.GetValueString("strings_compact>string3", ""),
                  "A string");
    TB_VERIFY_STR(node.GetValueString("strings_compact>string4", ""),
                  "'A string'");
    TB_VERIFY_STR(node.GetValueString("strings_compact>string5", ""),
                  "\"A string\"");
    TB_VERIFY_STR(node.GetValueString("strings_compact>string6", ""),
                  "\"A string\"");
    ...
    TB_VERIFY_STR(node.GetValueString("strings_compact>string11", ""),
                  "\"\"\'\'");
    TB_VERIFY_STR(node.GetValueStringRaw("strings_compact>string12", ""),
                  "@language_string_token");
    TB_VERIFY_STR(node.GetValueString("strings_compact>string13", ""),
                  "#ffdd00");
  }
  ...
  TB_TEST(numbers_with_unit) {
    ...
    TB_VERIFY_STR(node.GetValueString("numbers_with_unit>number2", ""),
                  "-10px");
    ...
    TB_VERIFY_STR(node.GetValueString("numbers_with_unit>number4", ""),
                  "-10px");
    TB_VERIFY_FLOAT(node.GetValueFloat("numbers_with_unit>number5", 0), -2.1);
    TB_VERIFY_STR(node.GetValueString("numbers_with_unit>number5", ""),
                  "-2.1px");
    TB_VERIFY_FLOAT(node.GetValueFloat("numbers_with_unit>number6", 0), -.1);
    TB_VERIFY_STR(node.GetValueString("numbers_with_unit>number6", ""),
                  "-.1px");
  ...
  TB_TEST(compact_with_children) {
    TB_VERIFY_STR(node.GetValueString("compact_with_children>string", ""),
                  "A string");
    TB_VERIFY_STR(
    ...
    TB_VERIFY_FLOAT(node.GetValueFloat("compact_with_children>float>child1", 0),
                    1);
    TB_VERIFY_FLOAT(node.GetValueFloat("compact_with_children>float>child2", 0),
                    2);
  }

  TB_TEST(compact_no_value) {
    TB_VERIFY_STR(node.GetValueString("compact_no_value>string", ""),
                  "A string");
    TB_VERIFY(node.GetValueInt("compact_no_value>int", 0) == 42);
    TB_VERIFY_FLOAT(node.GetValueFloat("compact_no_value>float", 0), 3.14);
    TB_VERIFY_STR(node.GetValueString("compact_no_value>subgroup>string1", ""),
                  "A string, with \"comma\"");
    TB_VERIFY_STR(node.GetValueString("compact_no_value>subgroup>string2", ""),
                  "'Another string'");
    TB_VERIFY_STR(node.GetValueString("compact_no_value>subgroup>string3", ""),
                  "And another string");
  }
  ...
  TB_TEST(arrays_dimensions) {
    ...
    TB_VERIFY(arr_n);
    TB_VERIFY(arr_n->value().array_size() == 2);
    ValueArray* arr = arr_n->value().as_array();
    TB_VERIFY(arr->at(0)->as_integer() == 1);
    TB_VERIFY(arr->at(1)->as_integer() == 2);
  }
  ...
  TB_TEST(strings_multiline) {
    TB_VERIFY_STR(node.GetValueString("strings_multiline>string1", ""),
                  "Line 1\nLine 2\nLine 3");
    ...
    TB_VERIFY_STR(node.GetValueString("strings_multiline>string4", ""),
                  "Line 1\nLine 2\nLine 3\n");
    TB_VERIFY_STR(node.GetValueString("strings_multiline>subgroup>first", ""),
                  "Foo");
    TB_VERIFY_STR(node.GetValueString("strings_multiline>subgroup>second", ""),
                  "AB");
    TB_VERIFY_STR(node.GetValueString("strings_multiline>string5", ""),
                  "The last string");
  }
  ...
  TB_TEST(include_file) {
    TB_VERIFY_STR(node.GetValueString("include_file>file1>something1", ""),
                  "Chocolate");
    TB_VERIFY_STR(node.GetValueString("include_file>file1>something2", ""),
                  "Cake");
    TB_VERIFY_STR(node.GetValueString("include_file>file2>something1", ""),
                  "Chocolate");
    TB_VERIFY_STR(node.GetValueString("include_file>file2>something2", ""),
                  "Cake");
  }

  TB_TEST(include_locally) {
    TB_VERIFY_STR(node.GetValueString("include_branch>test1>skin", ""),
                  "DarkSkin");
    TB_VERIFY_STR(node.GetValueString("include_branch>test2>skin", ""),
                  "LightSkin");
  }
  ...
  TB_TEST(local_ref) {
    ...
    TB_VERIFY_STR(node.GetValueString("defines_test>broken", ""),
                  "@>defines>colors>broken");
    TB_VERIFY_STR(node.GetValueString("defines_test>cycle", ""),
                  "@>defines_test>cycle");
  }
